...
import { OPENAI_MODELS } from "@autoflow/shared";
...
export const OpenAIDialog = ({
  ...
  const openaiCredentials = (credentialsData?.items ?? []).filter(
    (c) => c.type === "OPENAI",
  );
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure the OpenAI settings here.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Select an OpenAI credential or{" "}
                    <Link
            ...
            <FormField
              ...
              render={({ field, fieldState }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Select the OpenAI model you want to use for this node.
                  </FormDescription>
                  {fieldState.error && (
                    <FieldError className="text-red-500">
                      {fieldState.error.message}
