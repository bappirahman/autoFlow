...
ALTER TABLE "workflow" ALTER COLUMN "id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "workflow" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
...
ALTER TABLE "workflow" ALTER COLUMN "updated_at" SET DEFAULT now();